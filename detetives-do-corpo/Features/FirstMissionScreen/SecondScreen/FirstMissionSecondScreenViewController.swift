...
class FirstMissionSecondScreenViewController: UIViewController {
  private let baseView = FirstMissionSecondScreenView()
  private let viewModel: FirstMissionSecondScreenViewModelProtocol
  
  init(viewModel: FirstMissionSecondScreenViewModelProtocol) {
