...
class SecondMissionFirstScreenViewController: UIViewController {
  private let baseView = SecondMissionFirstScreenView()
  private let viewModel: SecondMissionFirstScreenViewModelProtocol
  
  init(viewModel: SecondMissionFirstScreenViewModelProtocol) {
