...
class SecondMissionSecondScreenViewController: UIViewController {
  private let baseView = SecondMissionSecondScreenView()
  private let viewModel: SecondMissionSecondScreenViewModelProtocol
  
  init(viewModel: SecondMissionSecondScreenViewModelProtocol) {
